...
/----------------------------------------------------------------------*/
  ...
  extern void te_get_envvars(void);
...
#endif
   OutClose(GlobalOut);
   extern void writeDummyTrailInput();
   writeDummyTrailInput(); // this lets know that the proof has been written; avoids an error on read.
   return retval;
}
